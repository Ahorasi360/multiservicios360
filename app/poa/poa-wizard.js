...
const TRANSLATIONS = {
  en: { 
    ...
    upsellNotaryDesc: "Platform fee to coordinate an independent notary. Notary is an independent provider and charges separately.", 
    ...
    upsellNotaryDesc: "Platform fee to coordinate an independent online notary. Notary fees are charged separately by the notary.", 
    upsellNotaryPrice: "+$150", 
    upsellNotarySave: "Convenient", 
    upsellRecording: "RECORDING COORDINATION", 
    upsellRecordingDesc: "Platform fee to coordinate county recording for real estate POA. County recording fees are additional.", 
  ...
  es: { 
    ...
    upsellNotaryDesc: "Cargo de plataforma para coordinar notario independiente. El notario cobra sus honorarios por separado.", 
    ...
    upsellNotaryDesc: "Cargo de plataforma para coordinar notario en línea. El notario es independiente y cobra sus honorarios por separado.", 
    upsellNotaryPrice: "+$150", 
    upsellNotarySave: "Conveniente", 
    upsellRecording: "COORDINACIÓN DE REGISTRO", 
    upsellRecordingDesc: "Cargo de plataforma para coordinar registro del condado para POA de bienes raíces. Las tarifas del condado son adicionales.", 
    upsellRecordingPrice: "+$250", 
