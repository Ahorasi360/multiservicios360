...
function SuccessContent() {
  ...
  const generatePDF = (isSpanish = false) => {
    ...
    // ============================================
    // CALIFORNIA NOTARY DISCLAIMER BOX - Required per CA Civil Code
    // ============================================
    doc.setLineWidth(1);
    doc.rect(m, y, cw, 28);
    y += 6;
    ...
    const disclaimerText = lang === 'es'
      ? 'Un notario publico u otro oficial que complete este certificado verifica unicamente la identidad del individuo que firmo el documento al cual este certificado esta adjunto, y no la veracidad, exactitud o validez de ese documento.'
      : 'A notary public or other officer completing this certificate verifies only the identity of the individual who signed the document to which this certificate is attached, and not the truthfulness, accuracy, or validity of that document.';
    y = wrap(disclaimerText, m + 3, y, cw - 6, 4.5);
    y += 12;
    doc.setLineWidth(0.5);
