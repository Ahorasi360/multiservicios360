...
const T = {
  es: {
    ...
    documents: [
      ...
      {
        key: 'small_estate_affidavit',
        icon: <ShieldIcon />,
        color: '#1E3A8A',
        bgColor: '#EFF6FF',
        badge: 'Sin Probate',
        badgeColor: '#1E3A8A',
        title: 'Declaración Jurada de Sucesión',
        subtitle: 'Small Estate Affidavit §13100',
        price: '$149',
        desc: 'Reclame bienes de una herencia bajo $184,500 en California sin abrir probate formal. Proceso simplificado bajo el Código de Sucesiones §13100.',
        features: [
          'Sin necesidad de abogado ni corte',
          'Para estates bajo $184,500 en California',
          'Formulario notarial incluido en PDF',
          'Proceso listo en 40 días desde defunción',
        ],
        url: '/small-estate-affidavit',
        requiresTrust: false,
      },
      {
        key: 'quitclaim_deed',
        ...
        color: '#059669',
        bgColor: '#ECFDF5',
        badge: 'Transferencia de Propiedad',
        badgeColor: '#059669',
        title: 'Escritura de Traspaso',
        subtitle: 'Quitclaim Deed',
        price: '$199',
        desc: 'Transfiera su propiedad a un familiar, póngala en un fideicomiso, o elimine un ex del título. La herramienta estándar para transferencias familiares en California.',
        features: [
          'Transferencia a fideicomiso en vida',
          'Agregar o eliminar nombre del título',
          'Incluye formulario PCOR del condado',
          'Requiere notarización y registro en condado',
        ],
        url: '/quitclaim-deed',
        requiresTrust: false,
      },
      {
        key: 'apostille_letter',
        icon: <GlobeIcon />,
        color: '#7C3AED',
        bgColor: '#F5F3FF',
        badge: '+120 Países',
        badgeColor: '#7C3AED',
        title: 'Solicitud de Apostilla',
        subtitle: 'Apostille Request',
        price: '$79',
        desc: 'Use sus documentos de California en México, Guatemala, Colombia y más de 120 países del Convenio de La Haya. Carta de solicitud para el Secretario de Estado.',
        features: [
          'Válida en todos los países de América Latina',
          'Tramitada ante el Secretary of State CA',
          'Para poderes notariales, actas, diplomas',
          'Incluye instrucciones de envío completas',
        ],
        url: '/apostille-letter',
        requiresTrust: false,
      },
    ],
    packages: {
  ...
  en: {
    ...
    documents: [
      ...
      },
      {
        ...
        subtitle: 'Declaración Jurada de Sucesión',
        price: '$149',
        desc: 'Claim inheritance assets under $184,500 in California without formal probate. Simplified process under Probate Code §13100.',
        features: [
          'No attorney or court required',
          'For California estates under $184,500',
          'Notary acknowledgment included in PDF',
          'Can be used 40 days after date of death',
        ],
        url: '/en/small-estate-affidavit',
        requiresTrust: false,
      },
      {
        key: 'quitclaim_deed',
        ...
        subtitle: 'Escritura de Traspaso',
        price: '$199',
        desc: 'Transfer your property to a family member, place it in a trust, or remove an ex-spouse from the title. The standard tool for family transfers in California.',
        features: [
          'Transfer to living trust',
          'Add or remove name from title',
          'Includes county PCOR form',
          'Requires notarization and county recording',
        ],
        url: '/en/quitclaim-deed',
        requiresTrust: false,
      },
      {
        key: 'apostille_letter',
        ...
        badge: '120+ Countries',
        badgeColor: '#7C3AED',
        title: 'Apostille Request',
        subtitle: 'Solicitud de Apostilla',
        price: '$79',
        desc: 'Use your California documents in Mexico, Guatemala, Colombia, and 120+ Hague Convention countries. Request letter for the California Secretary of State.',
        features: [
          'Valid in all Latin American countries',
          'Filed with CA Secretary of State',
          'For POAs, certificates, diplomas',
          'Includes complete submission instructions',
        ],
        url: '/en/apostille-letter',
        requiresTrust: false,
      },
    ],
    packages: {
