...
export async function POST(request) {
  try {
    ...
    lineItems.push({
      price_data: {
        ...
        product_data: {
          ...
          description: isSpanish ? 'Poder Notarial Limitado de California' : 'California Limited Power of Attorney',
        },
    ...
    const session = await getStripe().checkout.sessions.create({
      ...
      mode: 'payment',
      success_url: `${baseUrl}/limited-poa/success?session_id={CHECKOUT_SESSION_ID}&matter_id=${matterId}`,
      cancel_url: `${baseUrl}/limited-poa?canceled=true`,
