...
const TRANSLATIONS = {
  es: {
    nav: { services: 'Servicios', about: 'Nosotros', contact: 'Contacto', consultation: 'Consulta Gratis' },
    hero: {
  ...
  en: {
    nav: { services: 'Services', about: 'About', contact: 'Contact', consultation: 'Free Consultation' },
    hero: {
