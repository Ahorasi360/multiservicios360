...
const T = {
  es: {
    ...
    serviceLabels: { general_poa: 'Poder Notarial General', limited_poa: 'Poder Notarial Limitado', living_trust: 'Fideicomiso en Vida', llc_formation: 'Formación de LLC' },
  ...
  en: {
    ...
    serviceLabels: { general_poa: 'General POA', limited_poa: 'Limited POA', living_trust: 'Living Trust', llc_formation: 'LLC Formation' },
