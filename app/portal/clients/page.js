...
const T = {
  es: {
    brand: 'Portal de Socios', partnerAccount: 'Cuenta de Socio', membership: '💳 Membresía', signOut: 'Cerrar Sesión', dashboard: 'Panel', logout: 'Cerrar Sesión',
  ...
  en: {
    brand: 'Partner Portal', partnerAccount: 'Partner Account', membership: '💳 Membership', signOut: 'Sign Out', dashboard: 'Dashboard', logout: 'Logout',
      ...
      <nav className="bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex space-x-1">
            ...
            <button onClick={() => router.push('/portal/clients')} className="px-4 py-3 text-sm font-medium border-b-2 transition-colors text-blue-600 border-blue-600">{t.nav.clients}</button>
