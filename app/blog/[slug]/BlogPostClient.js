...
var translations = {
  es: {
    ...
    ctaSub: 'Nuestra plataforma le permite hacerlo usted mismo, en español, en minutos.',
    share: 'Compartir',
  },
  en: {
    ...
    ctaSub: 'Our platform lets you do it yourself, in Spanish, in minutes.',
    share: 'Share',
  },
};
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="bg-amber-400">
        <div className="max-w-7xl mx-auto px-4 py-2">
          <p className="text-gray-900 text-xs text-center font-medium">
      ...
      <div className="bg-gray-50 border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-4 py-3">
          <Link href="/blog" className="text-blue-700 hover:text-blue-900 text-sm font-medium no-underline">
            {t.backBlog}
          </Link>
        </div>
      </div>
      ...
      <article className="max-w-3xl mx-auto px-4 py-10">
        {post.image ? (
          ...
          <div className="aspect-[3/1] rounded-xl bg-gradient-to-br from-blue-100 to-blue-50 mb-8 flex items-center justify-center">
            <div className="w-20 h-20 bg-blue-800/10 rounded-2xl flex items-center justify-center">
              <svg className="w-10 h-10 text-blue-800/40" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-4">
          <span className={catColor + ' text-[11px] font-bold px-2.5 py-1 rounded-full'}>
        ...
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 mb-8 leading-tight">
          {title}
        </h1>
                  ...
                  <Link key={rp.slug} href={rpUrl} className="group bg-white rounded-xl shadow-sm hover:shadow-md transition-all no-underline overflow-hidden border border-gray-100">
                    <div className="aspect-[16/9] bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
                      {rp.image ? (
                        ...
                        <svg className="w-8 h-8 text-blue-800/30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                        </svg>
                      )}
                    </div>
      ...
      <section className="bg-white py-12 border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            <Link href="/poa" className="bg-green-600 hover:bg-green-700 text-white font-bold text-sm px-5 py-3 rounded-lg no-underline shadow-md transition-colors">Poder General →</Link>
            <Link href="/limited-poa" className="bg-orange-500 hover:bg-orange-600 text-white font-bold text-sm px-5 py-3 rounded-lg no-underline shadow-md transition-colors">Poder Limitado →</Link>
            <Link href="/trust" className="bg-blue-700 hover:bg-blue-800 text-white font-bold text-sm px-5 py-3 rounded-lg no-underline shadow-md transition-colors">Living Trust →</Link>
            <Link href="/llc" className="bg-slate-700 hover:bg-slate-600 text-white font-bold text-sm px-5 py-3 rounded-lg no-underline shadow-md transition-colors">Formar LLC →</Link>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white pt-10 pb-20 md:pb-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="border-t border-gray-800 pt-4">
            <p className="text-gray-600 text-[11px] text-center mb-3">Multi Servicios 360 no es un bufete de abogados y no proporciona asesoría legal.</p>
