...
const DOC_LABELS = {
  ...
  partner_registration: '🤝 Partner Registration — APPROVE IN ADMIN PANEL',
};

const MANUAL_DOCS = ['llc_formation', 'partner_registration']; // These require manual staff action
