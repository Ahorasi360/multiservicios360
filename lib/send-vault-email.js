...
<body style="margin:0;padding:0;background:#F1F5F9;font-family:Arial,Helvetica,sans-serif;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <tr>
            <td style="padding:24px 40px 20px;">
              <h2 style="color:#0F172A;font-size:20px;margin:0 0 12px;">Sus Documentos Están Listos!</h2>
              <p style="color:#475569;font-size:15px;line-height:1.6;margin:0 0 8px;">
                Hola${firstName ? ' ' + firstName : ''},
              </p>
              <p style="color:#475569;font-size:15px;line-height:1.6;margin:0 0 20px;">
                Sus documentos de <strong>${service.es}</strong> han sido completados y están listos para descargar. Acceda a ellos en cualquier momento usando su Bóveda de Documentos segura.
              </p>
              <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center" style="padding:8px 0 24px;">
                    <a href="${vaultUrl}" style="display:inline-block;background:#1E3A8A;color:#ffffff;padding:14px 32px;border-radius:8px;text-decoration:none;font-size:16px;font-weight:600;">Acceder a Su Bóveda de Documentos</a>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  <td style="padding:16px 20px;">
                    <p style="color:#64748B;font-size:13px;line-height:1.5;margin:0;">
                      ...
                      Este enlace expira en 90 días. Guárdelo o descargue sus documentos ahora.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background:#F8FAFC;padding:24px 40px;border-top:1px solid #E2E8F0;text-align:center;">
              ...
              <p style="color:#94A3B8;font-size:12px;line-height:1.5;margin:0 0 8px;">
                Plataforma de Software para Preparación de Documentos Legales
              </p>
  ...
  try {
    const { data, error } = await resend.emails.send({
      ...
      to: [email],
      subject: `Your Documents Are Ready / Sus Documentos Están Listos — Multi Servicios 360`,
      html,
    });
