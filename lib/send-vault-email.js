...
export async function sendVaultEmail(email, clientName, vaultUrl, serviceType) {
  const serviceNames = {
    ...
    affidavit: { en: 'Affidavit', es: 'Declaración Jurada' },
    authorization_letter: { en: 'Travel Authorization Letter', es: 'Carta de Autorización de Viaje' },
    promissory_note: { en: 'Promissory Note', es: 'Pagaré' },
    guardianship_designation: { en: 'Guardianship Designation', es: 'Designación de Tutor' },
    revocation_poa: { en: 'POA Revocation', es: 'Revocación de Poder Notarial' },
    pour_over_will: { en: 'Pour-Over Will', es: 'Testamento con Cláusula de Fideicomiso' },
    ...
    s_corp_formation: { en: 'S-Corporation Formation Package', es: 'Formación de S-Corporation' },
    c_corp_formation: { en: 'C-Corporation Formation Package', es: 'Formación de C-Corporation' },
