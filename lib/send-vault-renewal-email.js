...
export async function sendVaultRenewalEmail(email, name, token, stage, daysLeft) {
  ...
  const upgradeLink = `${SITE_URL}/vault?code=${token}#upgrade`;
  ...
  const templates = {
    ...
    twoMonths: {
      ...
      html: buildEmail({
        emoji: '📅', urgent: false,
        titleEn: 'Your Vault Expires in 2 Months',
        titleEs: 'Su Bóveda Vence en 2 Meses',
        bodyEn: `Hi <strong>${name}</strong>, your MS360 Document Vault will expire in <strong>${daysLeft} days</strong>. Renew now to keep uninterrupted access to your Power of Attorney, Living Trust, and other important documents.`,
        bodyEs: `Hola <strong>${name}</strong>, su Bóveda de Documentos MS360 vencerá en <strong>${daysLeft} días</strong>. Renueve ahora para mantener acceso continuo a su Poder Notarial, Fideicomiso y otros documentos importantes.`,
        ctaEn: '🔄 Renew My Vault', ctaEs: 'Renovar Mi Bóveda', ctaUrl: upgradeLink,
        secondCtaEn: '📂 View My Documents', secondCtaEs: 'Ver Mis Documentos', secondCtaUrl: vaultLink,
      }),
    },
    oneMonth: {
      subject: `⚠️ 30 days left on your vault / 30 días restantes en su bóveda`,
      html: buildEmail({
        emoji: '⚠️', urgent: false,
        titleEn: 'Only 30 Days Left on Your Vault',
        titleEs: 'Solo 30 Días Restantes en Su Bóveda',
        bodyEn: `Hi <strong>${name}</strong>, your Document Vault expires in <strong>30 days</strong>. After expiration you will lose access to your stored legal documents. Renew today to avoid interruption.`,
        bodyEs: `Hola <strong>${name}</strong>, su Bóveda de Documentos vence en <strong>30 días</strong>. Después de vencer, perderá acceso a sus documentos legales guardados. Renueve hoy para evitar interrupciones.`,
        ctaEn: '🔄 Renew Now', ctaEs: 'Renovar Ahora', ctaUrl: upgradeLink,
        secondCtaEn: '📂 Download My Documents', secondCtaEs: 'Descargar Mis Documentos', secondCtaUrl: vaultLink,
      }),
    },
    sevenDays: {
