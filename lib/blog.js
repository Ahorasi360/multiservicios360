...
export function getAllPosts() {
  ...
  const posts = files.map(filename => {
    ...
    return {
      ...
      hasEnglishContent: content.includes('---EN---'),
    };
  });
...
export function getPostBySlug(slug) {
  ...
  return {
    ...
    hasEnglishContent: hasEnglish,
    cta_url: data.cta_url || null,
    cta_label: data.cta_label || null,
    cta_url_en: data.cta_url_en || data.cta_url || null,
    cta_label_en: data.cta_label_en || data.cta_label || null,
  };
}
